...
### Pedagogia
- [ ] Audiolivro das 10 lições
- [ ] Vídeo introdutório YouTube (5 min)
- [ ] Flashcards Anki — deck oficial publicado
- [ ] Manual com 20 lições (expansão do atual 10)
...
- [ ] Geração natural por IA (LLM treinado em Tapi)
...
|---------|-------|-----------|-----------|
| Palavras | ~500 | 5.000 | 30.000 |
| Textos | ~10 | 50 | 500 |
| Falantes | 0 | 3 | 100 |
| Stars GitHub | 0 | 100 | 1000 |
| Visitas/mês site | 0 | 1.000 | 50.000 |
